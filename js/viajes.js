class Viaje {
    ...
    constructor() {
        ...
        const buttonCargarMapa = document.querySelector("main>button");
        buttonCargarMapa.addEventListener("click", () => {
            this.verTodo();
            buttonCargarMapa.setAttribute("hidden", "");
        });

        this.generarCarrusel();
    }
    ...
    verTodo() {
        ...
        const marcador = `&markers=color:red%7C${this.latitud},${this.longitud}`;
        ...
        main.insertBefore(imgMapaEstatico, main.children[2]);
    ...
    generarCarrusel() {
        // Función para incorporar la animación al carrusel
        $(document).ready(() => {
            $("section").animate({scrollLeft: "+=200"}, 1000);
        });

        const slides = document.querySelectorAll("img");
        const nextSlide = document.querySelector("section button:nth-of-type(1)");
        let curSlide = 0;
        ...
        const prevSlide = document.querySelector("section button:nth-of-type(2)");
